...
export default function About() {
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Enterprise-grade backend solutions using Nest.js and PostgreSQL, ensuring data integrity and peak performance.",
    },
    {
      icon: <DesignServicesIcon sx={{ fontSize: 40 }} />,
      title: "Modern Frontend",
      description: "Cutting-edge user interfaces built with Next.js, React, and Tailwind CSS for exceptional user experiences.",
    },
    {
      icon: <CodeIcon sx={{ fontSize: 40 }} />,
      title: "Clean Code Philosophy",
      description: "We believe in writing maintainable, scalable code that stands the test of time and team collaboration.",
    },
  ];
